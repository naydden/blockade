...
public class Keyboard {
	...
	/** Last-pressed KeyCode UP DOWN LEFT RIGHT */
	private static KeyCode lastKeyCodeR = KeyCode.UP;
	/** Last-pressed KeyCode A S D W */
	...
	public static void storeLastKeyCode(KeyCode keycode) {
		...
		} else if (keycode == KeyCode.W || keycode == KeyCode.D || keycode == KeyCode.A || keycode == KeyCode.S) {
	 ...
	 */
	public static KeyCode getLastKeyCodeL() {
		return lastKeyCodeL;
	}

	public static KeyCode getLastKeyCodeR() {
		return lastKeyCodeR;
	}
